...
- Control data size with `ParallelTransferOptions `, Improved performance of `BlockBlobOutputStream` and llow users to provide parallel transfer options using `BlockBlobClient`. Please see the [Storage
