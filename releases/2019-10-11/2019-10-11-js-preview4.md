...
To install the packages, copy and paste the below into a terminal.
    ...
    $> npm install @azure/keyvault-keys@4.0.0-preview.8
    $> npm install @azure/keyvault-secrets@4.0.0-preview.8
