...
- For Python, use [apistubgen](https://github.com/Azure/azure-sdk-tools/tree/master/packages/python-packages/api-stub-generator) to produce a single file with your public API surface.  Upload the output json file to the [ApiView tool](http://apiview.dev).
