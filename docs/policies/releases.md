...
An iOS release includes a Tag and Release (e.g. [1.0.0-beta.2](https://github.com/Azure/azure-sdk-for-ios/releases/tag/1.0.0-preview.2)) on GitHub and documentation as GitHub Pages (e.g. [1.0.0-beta.2](https://github.com/Azure/azure-sdk-for-ios/tree/1.0.0-beta.2)).
