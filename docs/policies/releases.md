...
```markdown
Please note, this package has been deprecated. A replacement package is available <br>[package name](https://dummylinktopackage.com/) as of [date-MM/YY]. We strongly <br>encourage you to upgrade to continue receiving updates. See the <br>[Migration Guide](https://dummylink.com/) for guidance on upgrading. Refer to our <br>[deprecation policy](https://azure.github.io/azure-sdk/policies_support.html) for more details.
```
