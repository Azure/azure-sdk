...
For libraries using the Azure SDK for .NET repository, dependency versions are [managed centrally](https://github.com/Azure/azure-sdk-for-net/blob/main/eng/centralpackagemanagement/Directory.Packages.props) and will automatically be applied to your library as part of the Azure SDK engineering system builds.
