...
{% include requirement/MUST id="rust-builders-private-fields" %} ensure all fields of the options type being constructed by the builder are not public. All fields must have `with_` setting functions.
