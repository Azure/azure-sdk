...
class Thing(object):
    ...
    def from_response(self, response):
        # type: (azure.core.pipeline.HttpResponse) -> Thing
...
class ExampleClient(object):
    ...
    def __init__(self, endpoint, credential, **kwargs):
        ...
        :type transport: ~transports.HttpTransport
        """
    ...
    def get_thing(self, name, **kwargs):
        # type: (str, **Any) -> Thing
    ...
    def begin_restart_thing(self, name, **kwargs) -> azure.core.polling.LROPoller[bool]:
        # type: (str, **Any) -> azure.core.polling.LROPoller[bool]
        """Restart the thing
