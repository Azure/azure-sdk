...
Service teams should schedule reviews of their client libraries with the ADP Review Board.  See the [Review Process](https://azure.github.io/azure-sdk/policies_reviewprocess.html) for more information.
